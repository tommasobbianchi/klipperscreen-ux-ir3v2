...
class Panel(ScreenPanel):
    ...
    def add_device(self, device):
        ...
        # ux: present each heater as one big flat card (icon + name | temp);
        ...
        card.get_style_context().add_class("ux-heater-card")
    ...
    def create_left_panel(self):
        ...
        name = Gtk.Label()
        temp = Gtk.Label()  # ux: cards are self-describing, drop the column header
