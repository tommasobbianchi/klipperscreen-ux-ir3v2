...
class Panel(ScreenPanel):
    ...
    def __init__(self, screen, title):
        ...
        js = 0.7
        self.buttons = {
            "x+": self._gtk.Button("arrow-right", "X+", "color1", js),
            "x-": self._gtk.Button("arrow-left", "X-", "color1", js),
            "y+": self._gtk.Button("arrow-up", "Y+", "color2", js),
            "y-": self._gtk.Button("arrow-down", "Y-", "color2", js),
            "z+": self._gtk.Button("z-farther", "Z+", "color3", js),
            "z-": self._gtk.Button("z-closer", "Z-", "color3", js),
            "home": self._gtk.Button("home", _("Home"), "color4", js),
            "motors_off": self._gtk.Button("motor-off", _("Disable Motors"), "color4", js),
        }
        ...
        self.labels["move_menu"] = Gtk.Grid(
            row_homogeneous=False, column_homogeneous=True, valign=Gtk.Align.FILL
        )
